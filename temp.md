...
vector<int> b;
inline void insert_pre(int i,int pos,int l,int r,int f){if(pos>=1&&pos<=n)pre[pos].pb({i,l,r,f});}
inline void insert_suf(int i,int pos,int l,int r,int f){if(pos>=1&&pos<=n)suf[pos].pb({i,l,r,f});}
int work()
{
